const ROUTES = Object.freeze(['home','label','manifest','batch','tracking','customers','stock','run','archive','claims','reconciliation','reports','notify','settlements','sync','profiles','settings']);
